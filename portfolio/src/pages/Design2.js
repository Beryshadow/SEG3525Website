...
const TRANSLATIONS = {
  fr: {
    ...
    desc: "Un jeu interactif sur navigateur conçu pour tester le rappel cognitif et l'engagement.",
    navAbout: "À propos",
    navProjects: "Projets"
  },
  en: {
    ...
    desc: "An interactive browser game designed to test cognitive recall and engagement.",
    navAbout: "About",
          ...
          <div className="col-lg-9 d-flex align-items-center justify-content-center">
            <div className="neu-panel p-10 text-center max-w-3xl w-100 mt-16 lg:mt-0">
              <div className="neu-pressed w-24 h-24 mx-auto flex items-center justify-center mb-8 rounded-full">
                <i className="fas fa-brain fa-2x text-accent opacity-80"></i>
              </div>
