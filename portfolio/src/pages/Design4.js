...
const TRANSLATIONS = {
  fr: {
    back: "Retour",
    comingSoon: "À venir",
    title: "Tableau de bord d'escalade",
    desc: "Visualisation de données pour aider les grimpeurs à suivre leurs cotations et séances.",
    navAbout: "À propos",
    navProjects: "Projets",
  },
  en: {
    ...
    title: "Climbing Dashboard",
    desc: "Data visualization to help climbers track their grades and sessions.",
    navAbout: "About",
          ...
          <div className="col-lg-9 d-flex align-items-center justify-content-center">
            <div className="neu-panel p-10 text-center max-w-3xl w-100 mt-16 lg:mt-0">
              <div className="neu-pressed w-24 h-24 mx-auto flex items-center justify-center mb-8 rounded-full">
                <i className="fas fa-mountain fa-2x text-accent opacity-80"></i>
              </div>
