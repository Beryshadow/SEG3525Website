// Stop words for robust hint generation
export const STOP_WORDS = new Set([
  // English
  "the", "a", "an", "is", "are", "and", "or", "to", "in", "of", "on", "it", "with", "for", "as", "by", "this", "that", "which", "what", "how", "why",
  // French
  "le", "la", "les", "un", "une", "des", "et", "ou", "à", "de", "en", "pour", "dans", "par", "sur", "avec", "est", "sont", "ce", "cette", "ces", "qui", "que", "quoi", "comment", "pourquoi", "il", "elle", "ils", "elles", "je", "tu", "nous", "vous", "on", "au", "aux", "du", "ne", "pas"
]);
