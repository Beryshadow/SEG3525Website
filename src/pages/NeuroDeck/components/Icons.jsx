...
export const ActivityIcon = () => <i className="fas fa-chart-line text-xl"></i>;
export const CheckIcon = () => <i className="fas fa-check"></i>;
export const XIcon = () => <i className="fas fa-times"></i>;
export const UploadIcon = () => <i className="fas fa-upload"></i>;
export const DownloadIcon = () => <i className="fas fa-download"></i>;
export const SaveIcon = () => <i className="fas fa-save"></i>;
...
export const LightbulbIcon = () => <i className="fas fa-lightbulb"></i>;
export const SparklesIcon = () => <i className="fas fa-magic"></i>;
export const ClockIcon = () => <i className="fas fa-clock"></i>;
export const RandomIcon = () => <i className="fas fa-random"></i>;
export const SeqIcon = () => <i className="fas fa-exchange-alt"></i>;
