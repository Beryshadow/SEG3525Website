export const TRANSLATIONS = {
  FR: {
    ...
    baseRescueThresholdTooltip: "Score d'implication NLI minimal (0,40 à 0,95) requis pour repêcher une réponse reformulée.",
    equivalenceThresholdTitle: "Équivalence Sémantique Élevée",
    equivalenceThresholdTooltip: "Seuil (0,50 à 0,95) à partir duquel deux réponses sont considérées comme des reformulations équivalentes.",
    distractorMarginTitle: "Marge de Discrimination",
    distractorMarginTooltip: "Facteur (1,5x à 6,0x) exigeant que la bonne réponse surpasse les choix de distracteurs incorrects.",
    embeddingScalingTitle: "Exposant de Plongement",
    embeddingScalingTooltip: "Exposant d'échelle non linéaire (0,50 à 1,00) appliqué à la similarité cosinus vectorielle.",
  ...
  EN: {
    ...
    baseRescueThresholdTooltip: "Minimum NLI entailment score (0.40–0.95) required to grant semantic rescue credit for differently phrased answers.",
    equivalenceThresholdTitle: "Semantic Equivalence",
    equivalenceThresholdTooltip: "Threshold (0.50–0.95) above which two answers are treated as functionally identical paraphrases.",
    distractorMarginTitle: "Distractor Margin",
    distractorMarginTooltip: "Required ratio (1.5x–6.0x) by which the correct answer's score must exceed incorrect distractor choice scores.",
    embeddingScalingTitle: "Embedding Exponent",
    embeddingScalingTooltip: "Non-linear scaling exponent (0.50–1.00) applied to vector cosine similarity to adjust scoring sensitivity.",
