export const TRANSLATIONS = {
  FR: {
    ...
    dataBackupDesc: "Gérez vos paquets en les exportant, en les partageant via le cloud, ou en observant l'importation brute.",
    ...
    newStatus: "Nouveau",
    mastery: "Maîtrise :",
    totalAnswered: "Réponses totales",
    ...
    myDecksTitle: "Gestion des Paquets",
    deckManagementTitle: "Gestion des Paquets",
    proceduralTheme: "Thème de Paquet Procédural",
    proceduralThemeDesc: "Changer dynamiquement la couleur de fond et les accents en fonction du paquet actif.",
    lsManagerTitle: "Inspecteur du Stockage Local",
    lsManagerDesc: "Consulter et supprimer sélectivement les éléments stockés dans localStorage.",
    ...
    comeBackInSeconds: "Revenez dans ~{seconds} secondes",
    mastered: "MAÎTRISÉ",
    semanticGamification: "Gamification Sémantique (Bêta)",
    boilingHot: "Bouillant ! 🔥",
    gettingWarmer: "Réchauffement ☀️",
    freezingCold: "Glacial 🧊",
    prevCard: "Précédent",
    nextCard: "Suivant",
    aiCalibrationTitle: "Calibration des Seuils IA Avancés",
    aiCalibrationDesc: "Ajustez la tolérance sémantique, la discrimination des distracteurs et la pondération des plongements vectoriels.",
    baseRescueThresholdTitle: "Seuil de Secours Sémantique",
    baseRescueThresholdTooltip: "Score d'implication NLI minimal (0,40 à 0,95) requis pour repêcher une réponse reformulée. [ÉLEVÉ = PLUS STRICT / MOINS TOLÉRANT | BAS = PLUS TOLÉRANT]",
    equivalenceThresholdTitle: "Équivalence Sémantique Élevée",
    equivalenceThresholdTooltip: "Seuil (0,50 à 0,95) à partir duquel deux réponses sont considérées comme des reformulations équivalentes. [ÉLEVÉ = PLUS STRICT / MOINS TOLÉRANT | BAS = PLUS TOLÉRANT]",
    distractorMarginTitle: "Marge de Discrimination",
    distractorMarginTooltip: "Facteur (1,5x à 6,0x) exigeant que la bonne réponse surpasse les choix de distracteurs incorrects. [ÉLEVÉ = PLUS STRICT / MOINS TOLÉRANT | BAS = PLUS TOLÉRANT]",
    embeddingScalingTitle: "Exposant de Plongement",
    embeddingScalingTooltip: "Exposant d'échelle non linéaire (0,50 à 1,00) appliqué à la similarité cosinus vectorielle. [ÉLEVÉ = PLUS STRICT / MOINS TOLÉRANT | BAS = PLUS TOLÉRANT]",
    resetDefaultsBtn: "Réinitialiser",
    resetDefaultsToast: "Seuils d'évaluation IA réinitialisés aux valeurs recommandées",
    modelDiagnosticsTitle: "Santé des Modèles & Micro-Diagnostics",
    modelDiagnosticsDesc: "Exécutez un micro-test en temps réel sur les modèles NLI et de plongement pour mesurer la latence d'inférence.",
    testNliBtn: "Tester le Modèle NLI",
    testEmbeddingBtn: "Tester le Modèle de Plongement",
    debugTelemetryTitle: "Télémétrie de Débogage IA (Panneau Frontend)",
    debugTelemetryDesc: "Affiche le détail des scores NLI, de la détection de posture et de similarité vectorielle à l'écran après chaque réponse.",
    nliInferenceEngineLabel: "Moteur d'Inférence NLI",
    embeddingVectorEngineLabel: "Moteur Vectoriel de Plongement",
    nliTestingMsg: "Exécution du micro-test NLI (Prémisse vs Hypothèse)...",
    embTestingMsg: "Exécution du micro-test de plongement (Vectorisation & similarité cosinus)...",
    nliFunctional: "✅ NLI Opérationnel",
    embFunctional: "✅ Plongement Opérationnel",
    entailmentLabel: "Implication",
    contradictionLabel: "Contradiction",
    cosineSimLabel: "Sim. Cosinus",
    dimLabel: "Dim",
    nliNotReady: "⚠️ Le modèle NLI est en cours de téléchargement ou non initialisé. Sélectionnez un modèle NLI ci-dessus.",
    embNotReady: "⚠️ Le modèle de plongement est en cours de téléchargement ou non initialisé. Sélectionnez un modèle ci-dessus.",
    nliTestFailed: "❌ Échec du test NLI",
    embTestFailed: "❌ Échec du test de plongement",
    nliTestPassedToast: "Test NLI Réussi",
    embTestPassedToast: "Test de Plongement Réussi",
  ...
  EN: {
    ...
    dataBackupDesc: "Manage your decks by exporting them, sharing via the cloud, or importing raw JSON.",
    ...
    myDecksTitle: "Deck Management",
    deckManagementTitle: "Deck Management",
    proceduralTheme: "Procedural Deck Theme",
    proceduralThemeDesc: "Dynamically change app background and accent colors based on active deck.",
    lsManagerTitle: "Local Storage Inspector",
    lsManagerDesc: "Selectively view and delete individual stored data items in localStorage.",
    ...
    comeBackInSeconds: "Come back in ~{seconds} seconds",
    mastered: "MASTERED",
    semanticGamification: "Semantic Gamification (Beta)",
    boilingHot: "Boiling Hot! 🔥",
    gettingWarmer: "Getting Warmer ☀️",
    ...
    aiCalibrationTitle: "Advanced AI Threshold Calibration",
    aiCalibrationDesc: "Tune NLI rescue thresholds, embedding scaling exponents, and distractor margins dynamically.",
    baseRescueThresholdTitle: "Base Rescue Threshold",
    baseRescueThresholdTooltip: "Minimum NLI entailment score (0.40–0.95) required to grant semantic rescue credit. [HIGHER = STRICTER / LESS LENIENT | LOWER = MORE LENIENT]",
    equivalenceThresholdTitle: "Semantic Equivalence",
    equivalenceThresholdTooltip: "Threshold (0.50–0.95) above which two answers are treated as identical paraphrases. [HIGHER = STRICTER / LESS LENIENT | LOWER = MORE LENIENT]",
    distractorMarginTitle: "Distractor Margin",
    distractorMarginTooltip: "Required multiplier (1.5x–6.0x) by which correct answer must surpass distractor choices. [HIGHER = STRICTER / LESS LENIENT | LOWER = MORE LENIENT]",
    embeddingScalingTitle: "Embedding Exponent",
    embeddingScalingTooltip: "Non-linear scaling exponent (0.50–1.00) applied to vector cosine similarity. [HIGHER = STRICTER / LESS LENIENT | LOWER = MORE LENIENT]",
    resetDefaultsBtn: "Reset",
    resetDefaultsToast: "AI Calibration Reset to Defaults",
    modelDiagnosticsTitle: "Model Health & Micro-Diagnostics",
    modelDiagnosticsDesc: "Run a real-time predetermined micro test on active NLI and Embedding models to verify execution and measure latency.",
    testNliBtn: "Test NLI Model",
    testEmbeddingBtn: "Test Embedding Model",
    debugTelemetryTitle: "AI Debug Telemetry (Frontend Panel)",
    debugTelemetryDesc: "Show detailed breakdown of NLI entailment scores, stance detection, embedding similarities, and rescue rules on-screen after every answer.",
    nliInferenceEngineLabel: "NLI Inference Engine",
    embeddingVectorEngineLabel: "Embedding Vector Engine",
    nliTestingMsg: "Running NLI micro-test (Premise: HTML structure vs Hypothesis: Web layout)...",
    embTestingMsg: "Running Embedding micro-test (Vectorizing & computing cosine similarity)...",
    nliFunctional: "✅ NLI Functional",
    embFunctional: "✅ Embedding Functional",
    entailmentLabel: "Entailment",
    contradictionLabel: "Contradiction",
    cosineSimLabel: "Cosine Sim",
    dimLabel: "Dim",
    nliNotReady: "⚠️ NLI Model worker not loaded yet. Select an NLI model above and wait for initialization.",
    embNotReady: "⚠️ Embedding Model worker not loaded yet. Select an embedding model above and wait for initialization.",
    nliTestFailed: "❌ NLI Test Failed",
    embTestFailed: "❌ Embedding Test Failed",
    nliTestPassedToast: "NLI Test Passed",
    embTestPassedToast: "Embedding Test Passed",
