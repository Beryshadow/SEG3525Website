export const TRANSLATIONS = {
  FR: {
    ...
    dataBackupDesc: "Sauvegardez votre progression d'apprentissage, vos scores de maîtrise, l'ajustement de l'IA et les questions programmées dans un fichier.",
  ...
  EN: {
    ...
    dataBackupDesc: "Save your learning progress, mastery scores, AI tuning, and scheduled questions to a file.",
